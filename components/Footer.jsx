...
export default function Footer() {
  ...
  const quickLinks = [
    { name: 'Home', href: '/' },
    { name: 'Semesters', href: '/semester#browse-by-semester' },
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:whoismanish12@gmail.com" className="hover:text-teal-400 transition-colors">
                  whoismanish12@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 text-teal-600 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="container py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              © 2025 <span className="text-white">BIT Past Questions Nepal</span>. All rights reserved.
            </p>
